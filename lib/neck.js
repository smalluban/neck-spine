        ...
        if (typeof this.scope === 'object') {
          ...
          for (key in _ref) {
            ...
            if (string = this.el[0].dataset[key]) {
              ...
              childScope[key] = this.scope[key] !== '=' && this.scope[key] !== '@' ? this.scope[key] : void 0;
            }
          }
        } else if (this.scope === '@') {
...
RepeatItem = (function(_super) {
  ...
  RepeatItem.prototype.checkFilter = function() {
    if (!this.scope.filter && !this.visible) {
      this.el.show();
      return this.visible = true;
    } else {
      if (this.item.toString().match(new RegExp(this.scope.filter, 'gi'))) {
        if (!this.visible) {
          this.el.show();
          return this.visible = true;
        }
