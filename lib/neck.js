  ...
  Controller.prototype.render = function() {
    ...
    if (this.view || this.template) {
      ...
      if (typeof this.template === 'string') {
        ...
        this.el = $((require("" + Neck.Config.paths.view + "/" + this.view))(this.scope));
      }
      _ref1 = this.el;
...
Neck.Runner['attr'] = AttrRunner = (function(_super) {
...
Neck.Runner['bind'] = BindRunner = (function(_super) {
...
Neck.Runner['class'] = ClassRunner = (function(_super) {
...
Neck.Runner['element'] = ElementRunner = (function() {
...
Neck.Runner['helper'] = HelperRunner = (function() {
...
Neck.Runner['hide'] = HideRunner = (function(_super) {
...
Neck.Runner['repeat'] = RepeatRunner = (function(_super) {
...
Neck.Runner['route'] = Router = (function() {
...
Neck.Runner['route-back'] = Router = (function() {
  function Router(options) {
    var _this = this;
    options.el.on('click', function(e) {
      e.preventDefault();
...
Neck.Runner['show'] = ShowRunner = (function(_super) {
...
Neck.Runner['value'] = ValueRunner = (function(_super) {
